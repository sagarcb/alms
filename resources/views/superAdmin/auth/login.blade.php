            ...
            <div class="row flex-grow">
                <div class="col-lg-4 mx-auto">
                    <div class="auth-form-light text-left p-5">
                        ...
                        <form class="pt-3" action="{{route('superAdmin.auth')}}" method="post">
                            @csrf
                            <div class="form-group">
                                <input type="text" name="admin_id" class="form-control form-control-lg" id="exampleInputEmail1" placeholder="Admin Id" required>
